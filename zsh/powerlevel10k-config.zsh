# Generated by Powerlevel10k configuration wizard on 2022-08-10 at 23:49 PDT.
...
() {
  ...
  ########################################[ chruby ]###########################################
  typeset -g POWERLEVEL9K_CHRUBY_FOREGROUND='124'
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=131
  # Custom icon.
