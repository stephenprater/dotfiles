...
POWERLEVEL9K_ASDF_FOREGROUND='gray'
POWERLEVEL9K_ASDF_RUBY_FOREGROUND='124'
POWERLEVEL9K_ASDF_RUBY_SHOW_ON_UPGLOB="Gemfile"
POWERLEVEL9K_ASDF_NODEJS_FOREGROUND='131'
POWERLEVEL9K_ASDF_NODEJS_SHOW_ON_UPGLOB="package.json"
POWERLEVEL9K_ASDF_TERRAFORM_FOREGROUND='034'
POWERLEVEL9K_ASDF_PYTHON_FOREGROUND='green'
POWERLEVEL9K_ASDF_PYTHON_SHOW_ON_UPGLOB='*.py'
POWERLEVEL9K_ASDF_JAVA_SHOW_ON_UPGLOB="*.java"
POWERLEVEL9K_ASDF_JAVA_SHOW_ON_UPGLOB="*.java"
POWERLEVEL9K_ASDF_ERLANG_FOREGROUND='124'
POWERLEVEL9K_ASDF_ERLANG_SHOW_ON_UPGLOB="mix.exs"
POWERLEVEL9K_ASDF_ELIXIR_FOREGROUND='134'
POWERLEVEL9K_ASDF_ELIXIR_SHOW_ON_UPGLOB="mix.exs"
...
# Prompt Right
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time custom_tf_workspace asdf context os_icon)
POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR=''
