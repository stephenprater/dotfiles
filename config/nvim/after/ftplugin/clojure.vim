...
function! PrettyClojure()
  let l:string = "(do (require 'clojure.pprint) (with-out-str (clojure.pprint/pprint '" . @z . ")))" 
  let @z = fireplace#session_eval(l:string)
endfunction

nmap <buffer> <Leader>cpp "zyab:call PrettyClojure()<CR>"_dabpz
...
" as a comment.
nmap <buffer> <Leader>c! "zyab)<Esc>A<CR><Esc>"zpc!!
